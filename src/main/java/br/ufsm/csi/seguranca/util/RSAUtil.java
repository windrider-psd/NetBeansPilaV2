...
public class RSAUtil
{
    ...
    /*
        Aten��o: para gerar o seu par de chaves instale o programa OPENSSL executando os seguintes comandos:
        ...
        A sua chave privada estar� no arquivo Master_private_key.der e a p�blica no arquivo Master_public_key.der. Utilize esta classe
